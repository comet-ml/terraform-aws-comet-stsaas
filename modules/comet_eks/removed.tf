...
#    the permanent v6.0.3 tag WITHOUT this file. See MIGRATION.md at the repo root.
#
...
#
# Cut from v6.0.3 rather than v5.7.0 so Stage 1 lands directly on the v6 surface —
