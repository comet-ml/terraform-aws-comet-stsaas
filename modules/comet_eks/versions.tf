terraform {
  required_providers {
    ...
    # drop them from state (destroy = false). v5 no longer CREATES any kubernetes/helm
    # resource — greenfield clusters never instantiate these providers. See removed.tf
    # (DND-1573 / DND-1257 brownfield migration).
    kubernetes = {
